...
for i = 1:25
   xtest(:,:,i) = csvread(strcat('../images/Converted Images/Positive_converted/Face_',num2str(i+100),'_integral.dat')); 
end

for i = 1:25
    xtest(:,:,i+25) = csvread(strcat('../images/Converted Images/Negative_converted/neg_',num2str(i),'_integral.dat'));
end
