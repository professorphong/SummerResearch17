function C = StrongClassifier(x,ht,Bt)
...
for j = 1:size(Bt,2);
   if ht(j,1) == 1
       htx(j) =  weakclassifier(x,[1 0],[ht(j,2) ht(j,3)],[ht(j,4) ht(j,5)],ht(j,6),ht(j,7));
   elseif ht(j,1) == 2
       htx(j) =  weakclassifier(x,[1 0 1],[ht(j,2) ht(j,3)],[ht(j,4) ht(j,5)],ht(j,6),ht(j,7));
   elseif ht(j,1) == 3
       htx(j) =  weakclassifier(x,[1; 0],[ht(j,2) ht(j,3)],[ht(j,4) ht(j,5)],ht(j,6),ht(j,7));
   elseif ht(j,1) == 4
       htx(j) =  weakclassifier(x,[1;0;1],[ht(j,2) ht(j,3)],[ht(j,4) ht(j,5)],ht(j,6),ht(j,7));
   elseif ht(j,1) == 5
       htx(j) =  weakclassifier(x,[1 0;0 1],[ht(j,2) ht(j,3)],[ht(j,4) ht(j,5)],ht(j,6),ht(j,7));
   end
end
